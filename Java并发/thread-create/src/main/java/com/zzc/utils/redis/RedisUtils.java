...
public class RedisUtils {
    ...
    public static Collection<String> scan(final String pattern, final long limit) {
        ...
        try (final Cursor<String> cursor = redisTemplate.executeWithStickyConnection(connection -> new ConvertingCursor<>(connection.scan(options), keySerializer::deserialize))) {
            assert cursor != null;
