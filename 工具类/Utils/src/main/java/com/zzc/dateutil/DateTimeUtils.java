...
public class DateTimeUtils {
    ...
    @Nonnull
    public LocalDateTime yesterdayStartTime() {
        return atStartOfDay(yesterday());
    }

    @Nonnull
    public LocalDateTime yesterdayEndTime() {
        return atEndOfDay(yesterday());
    }
    ...
    public LocalDateTime atStartOfMonth() {
        return atStartOfMonth(LocalDate.now());
    }
